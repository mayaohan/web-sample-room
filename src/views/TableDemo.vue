  ...
  <div>
    <vxe-toolbar>
      <template #buttons>
        ...
        <vxe-button @click="exportDataEvent">默认导出csv</vxe-button>
        <vxe-button @click="exportSelectEvent">导出选中csv</vxe-button>
        <vxe-button @click="exportDataEventTxt">默认导出txt</vxe-button>
        <vxe-button @click="openExportEvent">导出xlsx</vxe-button>
      </template>
    </vxe-toolbar>
...
// 导出txt
exportDataEventTxt = ()=> {
  xTable.value.exportData({ type: 'txt' })
},
// 导出选中
exportSelectEvent = ()=> {
